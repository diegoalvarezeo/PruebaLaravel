<!-- Modal agregar-->
<div wire:ignore.self class="modal fade" id="equipoModal" tabindex="-1" aria-labelledby="equipoModalLabel"
    aria-hidden="true">
                ...
                <form wire:submit.prevent="guardarEquipo">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model="descripcion" name="descripcion" class="form-control"
                                required>
                            @error('descripcion')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" wire:model="precio" name="precio" class="form-control" required
                                min="0">
                            @error('precio')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
...
<div wire:ignore.self class="modal fade" id="updateequipoModal" tabindex="-1" aria-labelledby="updateequipoModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div wire:ignore.self class="modal fade" id="deleteequipoModal" tabindex="-1" aria-labelledby="deleteequipoModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
